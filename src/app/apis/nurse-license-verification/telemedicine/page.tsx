...
const RAPIDAPI_URL = 'https://rapidapi.com/lulzasaur9192/api/nurse-license-verification?utm_source=pricetrackr&utm_medium=seo-site&utm_campaign=telemedicine';
