...
export const metadata: Metadata = {
  alternates: { canonical: canonicalUrl('/apis/nurse-license-verification/staffing-agencies') },
...
const RAPIDAPI_URL = 'https://rapidapi.com/lulzasaur9192/api/nurse-license-verification1?utm_source=pricetrackr&utm_medium=seo-site&utm_campaign=staffing-agencies';
